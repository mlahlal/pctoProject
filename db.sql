...
-- insert into users (name, surname, type, email, telephone, password, province, id_school, field_of_study) values ("")
...
insert into school values ( "BSIS03300R", "IIS Cerebotani", "segreteria@cerebotani.it", "pec@cerebotani.it", "cerebotani.it", "Brescia", "cerebotani.it" );
